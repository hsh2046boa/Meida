...
import com.meida.emall.activity.B3_ProductPhotoActivity;
...
public class B3_ProductPhotoAdapter  extends BeeBaseAdapter{
    ...
    protected View bindData(final int position, View cellView, ViewGroup parent,
		...
		if(imageType.equals("high")) {
            imageLoader.displayImage(photo.thumb,holder.goodPhotoImageView, MeidaApp.options);
		} else if(imageType.equals("low")) {
            imageLoader.displayImage(photo.small,holder.goodPhotoImageView, MeidaApp.options);
		} else {
