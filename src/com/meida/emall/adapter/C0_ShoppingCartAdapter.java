...
import com.meida.emall.activity.E4_HistoryActivity;
import com.meida.emall.fragment.C0_ShoppingCartFragment;
import com.meida.emall.protocol.GOODS_LIST;
...
public class C0_ShoppingCartAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {		
		...
		if(imageType.equals("high")) {
            imageLoader.displayImage(goods.img.thumb,holder.image, MeidaApp.options);
		} else if(imageType.equals("low")) {
            imageLoader.displayImage(goods.img.small,holder.image, MeidaApp.options);
		} else {
