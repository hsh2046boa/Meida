...
import com.meida.emall.activity.E6_ShippingStatusActivity;
import com.meida.emall.protocol.GOODORDER;
import com.meida.emall.protocol.ORDER_GOODS_LIST;
...
//					image.setImageWithURL(context, goods_list.get(i).img.thumb, R.drawable.default_image);
                    imageLoader.displayImage(goods_list.get(i).img.thumb,image, MeidaApp.options);
				} else if(imageType.equals("low")) {
//					image.setImageWithURL(context, goods_list.get(i).img.small, R.drawable.default_image);
                    imageLoader.displayImage(goods_list.get(i).img.small,image, MeidaApp.options);
				} else {
