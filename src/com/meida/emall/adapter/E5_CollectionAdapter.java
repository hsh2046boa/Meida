...
public class E5_CollectionAdapter extends BaseAdapter {
	...
	public E5_CollectionAdapter(Context context, List<FAVOR> list, int flag) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(position*2+1 < list.size()) {
			...
			final FAVOR collect1 = list.get(position*2);
			final FAVOR collect2 = list.get(position*2+1);
			...
			holder.text1.setText(collect1.goods_name);
			holder.text2.setText(collect2.goods_name);
			
			imageLoader.displayImage(ProtocolConst.HOMELINK+collect1.default_image,holder.image1, MeidaApp.options);
			imageLoader.displayImage(ProtocolConst.HOMELINK+collect2.default_image,holder.image2, MeidaApp.options);
...
//                imageLoader.displayImage(collect1.img.thumb,holder.image1, MeidaApp.options);
//                imageLoader.displayImage(collect2.img.thumb,holder.image2, MeidaApp.options);
...
//                imageLoader.displayImage(collect1.img.small,holder.image1, MeidaApp.options);
//                imageLoader.displayImage(collect2.img.small,holder.image2, MeidaApp.options);
//			} else {
...
//			}
			...
			holder.price1.setText(collect1.price);
			holder.price2.setText(collect2.price);
