...
import com.meida.emall.activity.D1_CategoryActivity;
import com.meida.emall.activity.D2_FilterActivity;
import com.meida.emall.adapter.D0_CategoryAdapter;
import com.meida.emall.model.ProtocolConst;
import com.meida.emall.model.SearchModel;
...
public class D0_CategoryFragment extends BaseFragment implements OnClickListener, BusinessResponse {
	...
	public void showRecognizerDialog() {
		...
		RecognizerDialog recognizerDialog = new RecognizerDialog(getActivity(), "appid="+ MeidaManager.getXunFeiCode(getActivity()));
