...
import com.meida.emall.activity.*;
...
//        help.setOnClickListener(this);
		...
		order = (Button) headView.findViewById(R.id.profile_orders);
		money = (Button) headView.findViewById(R.id.profile_money);
		favor = (Button) headView.findViewById(R.id.profile_favor);
		address = (Button) headView.findViewById(R.id.profile_address);
		detail = (Button) headView.findViewById(R.id.profile_detail);
		notify = (Button) headView.findViewById(R.id.profile_msg);
		comment = (Button) headView.findViewById(R.id.profile_comment);
		logout = (Button) headView.findViewById(R.id.profile_logout);
		...
		File files = new File(getActivity().getCacheDir()+"/Emall/cache"+"/temp.jpg");
		if(files.exists()) {
			photo.setImageBitmap(BitmapFactory.decodeFile(getActivity().getCacheDir()+"/Emall/cache"+"/temp.jpg"));
		} else {
	...
	public void onClick(View v) {
		...
		case R.id.profile_orders:
			if (uid.equals("")) {
				...
				intent.putExtra("flag", "order_all");
...
//		case R.id.profile_head_address_manage:
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {  
        ...
        if (resultCode == Activity.RESULT_OK) {
        	...
        	if(requestCode == 1) {
                ...
                String fileName = getActivity().getCacheDir()+"/Emall/cache" +"/temp.jpg";
                try {
	...
	public static USER readUserInfo(String uid) {
