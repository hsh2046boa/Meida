...
import com.meida.emall.adapter.C0_ShoppingCartAdapter;
import com.meida.emall.adapter.E4_HistoryAdapter;
import com.meida.emall.model.OrderModel;
...
public class E4_HistoryActivity extends AlixPayActivity implements BusinessResponse, IXListViewListener {
	...
	protected void onCreate(Bundle savedInstanceState) {		
        ...
        String all=resource.getString(R.string.profile_orders);
		...
		messageHandler = new Handler(){
            ...
            public void handleMessage(final Message msg) {
                ...
                if (msg.what == 1)
                {
                    ...
                    if (MeidaManager.getAlipayCallback(getApplicationContext()) != null 
                    		&& MeidaManager.getAlipayParterId(getApplicationContext()) != null 
                    		&& MeidaManager.getAlipaySellerId(getApplicationContext()) != null
                    		&& MeidaManager.getRsaAlipayPublic(getApplicationContext()) != null
                    		&& MeidaManager.getRsaPrivate(getApplicationContext()) != null)
                    {
