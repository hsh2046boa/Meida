...
import com.meida.emall.adapter.GalleryImageAdapter;
...
public class GalleryImageActivity extends BaseActivity implements OnGestureListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {		
        ...
        if(!isFirstRun) {
        	Intent it = new Intent(this,A0_SigninActivity.class);
//        	Intent it = new Intent(this,EmallMainActivity.class);
            startActivity(it);
            finish();
        }
...
//        initLayout();
	...
	public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
		...
		if (e1.getX() - e2.getX() > 120) {      
			if(pager_num == 4) {
				Intent intent = new Intent(GalleryImageActivity.this,A0_SigninActivity.class);
//				Intent intent = new Intent(GalleryImageActivity.this,EmallMainActivity.class);
