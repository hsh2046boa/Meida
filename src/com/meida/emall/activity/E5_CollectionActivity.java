...
import com.meida.emall.adapter.E5_CollectionAdapter;
import com.meida.emall.model.CollectListModel;
...
//        };
	...
	public void setCollectList() {
		...
		if(collectListModel.favorList.size() == 0) {
			ToastView toast = new ToastView(this, nof);			
	        toast.setGravity(Gravity.CENTER, 0, 0);
	        toast.show();
			edit.setEnabled(false);
			if(collectAdapter != null) {
				collectAdapter.list = collectListModel.favorList;
				collectAdapter.notifyDataSetChanged();
				edit.setText(com);
			}
			...
			if(collectAdapter == null) {
				collectAdapter = new E5_CollectionAdapter(this, collectListModel.favorList, 1);
