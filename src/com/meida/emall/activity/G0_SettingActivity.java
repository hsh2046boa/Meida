...
//            it.putExtra(WebViewActivity.WEBURL, ConfigModel.getInstance().config.site_url);
            it.putExtra(WebViewActivity.WEBURL, "http://meida.zhuguanjia.net/");
            Resources resource = (Resources) getBaseContext().getResources();
...
//            it.putExtra(WebViewActivity.WEBURL, ConfigModel.getInstance().config.site_url);
            it.putExtra(WebViewActivity.WEBURL, "http://meida.zhuguanjia.net/");
            it.putExtra(WebViewActivity.WEBTITLE, "介绍");
            startActivity(it);
        	break;
        case R.id.setting_support:
        	Intent intent = new Intent(G0_SettingActivity.this, WebViewActivity.class);
            intent.putExtra(WebViewActivity.WEBURL, "http://meida.zhuguanjia.net/");
...
//		           
//		            Intent intent = new Intent(G0_SettingActivity.this, EmallMainActivity.class);
