...
import com.meida.emall.activity.EmallMainActivity;
import com.meida.emall.protocol.CATEGORYGOODS;
...
//            	good_cell_photo_one.setImageWithURL(mContext,goodOne.img.thumb,R.drawable.default_image);
                imageLoader.displayImage(goodOne.img.thumb,good_cell_photo_one, MeidaApp.options);
    		} else if(imageType.equals("low")) {
//    			good_cell_photo_one.setImageWithURL(mContext,goodOne.img.small,R.drawable.default_image);
                imageLoader.displayImage(goodOne.img.small,good_cell_photo_one, MeidaApp.options);
    		} else {
...
//                		good_cell_photo_two.setImageWithURL(mContext,goodTwo.img.thumb,R.drawable.default_image);
                        imageLoader.displayImage(goodTwo.img.thumb,good_cell_photo_two, MeidaApp.options);
            		} else if(imageType.equals("low")) {
//            			good_cell_photo_two.setImageWithURL(mContext,goodTwo.img.small,R.drawable.default_image);
                        imageLoader.displayImage(goodTwo.img.small,good_cell_photo_two, MeidaApp.options);
            		} else {
            			String netType = shared.getString("netType", "wifi");
            			if(netType.equals("wifi")) {
//            				good_cell_photo_two.setImageWithURL(mContext,goodTwo.img.thumb,R.drawable.default_image);
...
//            				good_cell_photo_two.setImageWithURL(mContext,goodTwo.img.small,R.drawable.default_image);
                    ...
                    good_cell_two.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
			                 ...
			                 mContext.startActivity(it);
			                 ((EmallMainActivity)mContext).overridePendingTransition(R.anim.push_right_in,R.anim.push_right_out);
						}
					});
...
//                    		good_cell_photo_three.setImageWithURL(mContext,goodThree.img.thumb,R.drawable.default_image);
                            imageLoader.displayImage(goodThree.img.thumb,good_cell_photo_three, MeidaApp.options);
                		} else if(imageType.equals("low")) {
//                			good_cell_photo_three.setImageWithURL(mContext,goodThree.img.small,R.drawable.default_image);
                            imageLoader.displayImage(goodThree.img.small,good_cell_photo_three, MeidaApp.options);
                		} else {
                			String netType = shared.getString("netType", "wifi");
                			if(netType.equals("wifi")) {
//                				good_cell_photo_three.setImageWithURL(mContext,goodThree.img.thumb,R.drawable.default_image);
