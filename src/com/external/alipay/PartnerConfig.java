...
//    public static final String ALIPAY_CALLBACK = "http://shop.ecmobile.me/ecmobile/respond.php";
    ...
    public PartnerConfig(Context context) {
    	PARTNER = MeidaManager.getAlipayParterId(context);
    	SELLER = MeidaManager.getAlipaySellerId(context);
    	RSA_PRIVATE = MeidaManager.getRsaPrivate(context);
    	RSA_ALIPAY_PUBLIC = MeidaManager.getRsaAlipayPublic(context);
    	ALIPAY_CALLBACK = MeidaManager.getAlipayCallback(context);
    }
